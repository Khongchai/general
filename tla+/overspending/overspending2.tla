...
(* This seems more complex but it reflect perfectly what's happening in the real system. The spec revealing hidden "spend" step is exactly the spec doing its job. *)
(*************)
